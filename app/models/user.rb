...
class User < ApplicationRecord
  ...
  has_many :follower_relationships, foreign_key: :following_id, class_name: 'Follow', inverse_of: :follower,
                                    dependent: :nullify
  has_many :followers, through: :follower_relationships, source: :follower

  has_many :following_relationships, foreign_key: :follower_id, class_name: 'Follow', inverse_of: :following,
                                     dependent: :nullify
